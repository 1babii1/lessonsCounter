          ...
          <View key={group._id} style={styles.groupCard}>
            ...
            <View style={styles.addStudentContainer}>
              <TextInput
                ...
                onChangeText={(text) =>
                  setNewStudentNames((prev) => ({ ...prev, [group._id]: text }))
                }
              />
              <TouchableOpacity
                style={styles.addSmallButton}
                onPress={() => addStudent(group._id)}
              >
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <TextInput
              ...
              onChangeText={(t) =>
                setLessonModal((prev) => ({ ...prev, amount: t }))
              }
            />
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <Text style={styles.modalTitle}>
              History for {historyModal.studentName}
            </Text>
            <ScrollView style={{ maxHeight: 300, width: "100%" }}>
              ...
              {historyModal.history.map((h, idx) => (
                <Text key={idx} style={styles.historyLine}>
                  {new Date(h.date).toLocaleString()}: {h.change > 0 ? "+" : ""}
                  {h.change}
                </Text>
              ))}
            </ScrollView>
